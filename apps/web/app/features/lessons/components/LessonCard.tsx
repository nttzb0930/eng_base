...
export const Card = ({
  ...
  const [audio, _, controls] = useAudio({
    src: audioSrc || "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA",
  });
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        (type === "ASSIST" || type === "FILL_BLANK") && "w-full lg:p-3"
      )}
    >
      {audio}
      {imageSrc && (
      ...
      <div
        className={cn(
          ...
          (type === "ASSIST" || type === "FILL_BLANK") && "flex-row-reverse"
        )}
      >
        {(type === "ASSIST" || type === "FILL_BLANK") && <div aria-hidden />}
        <p
          className={cn(
