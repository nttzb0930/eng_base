        ...
        <div className="pb-12">
          ...
          <div className="mb-7">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              {/* IELTS */}
              <div className="bg-card border-border/80 shadow-xs group cursor-pointer rounded-xl border p-4 transition-all hover:shadow-md">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-emerald-200 bg-emerald-50 text-xs font-extrabold text-emerald-600 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-400">
                      IELTS
                    </div>
                    <div>
                      <div className="text-foreground text-sm font-bold">
                        42 {t("words").toLowerCase()}
                      </div>
                      <div className="text-muted-foreground text-xs">
                        {t("learnedCount", { learned: 32, total: 42 })}
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-card border-border/80 shadow-xs group cursor-pointer rounded-xl border p-4 transition-all hover:shadow-md">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-blue-200 bg-blue-50 text-xs font-extrabold text-blue-600 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-400">
                      TOEIC
                    </div>
                    <div>
                      <div className="text-foreground text-sm font-bold">
                        28 {t("words").toLowerCase()}
                      </div>
                      <div className="text-muted-foreground text-xs">
                        {t("learnedCount", { learned: 18, total: 28 })}
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-card border-border/80 shadow-xs group cursor-pointer rounded-xl border p-4 transition-all hover:shadow-md">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-amber-200 bg-amber-50 text-xs font-extrabold text-amber-600 dark:border-amber-800 dark:bg-amber-950/50 dark:text-amber-400">
                      B1
                    </div>
                    <div>
                      <div className="text-foreground text-sm font-bold">
                        17 {t("words").toLowerCase()}
                      </div>
                      <div className="text-muted-foreground text-xs">
                        {t("learnedCount", { learned: 6, total: 17 })}
                      </div>
                    </div>
                  </div>
                        ...
                        >
                          ...
                          <td className="px-4 py-3.5">
                            ...
                            <div className="mt-1 flex gap-1">
                              <span className="bg-muted text-muted-foreground rounded px-1.5 py-0.5 text-[9px] font-semibold">
                                IELTS
                              </span>
                              <span className="bg-muted text-muted-foreground rounded px-1.5 py-0.5 text-[9px] font-semibold">
                                TOEIC
