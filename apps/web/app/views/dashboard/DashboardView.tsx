    ...
    <div className="w-full min-w-0">
      <FeedWrapper>
        <div className="flex w-full flex-col pb-12">
          ...
          <section className="from-brand-deep via-brand-dark to-brand shadow-brand relative mb-5 overflow-hidden rounded-lg bg-gradient-to-br p-5 text-white sm:p-8">
                  ...
                  >
                    ...
                    <div className="flex gap-1.5 self-center">
                      {dashboard.activity.map((day, idx) => {
                        ...
                        const letter = formatActivityWeekday(day.date, locale);
