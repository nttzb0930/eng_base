...
const planPath = path.join(normalizationDirectory, "vocab-db-update-plan.json");
const dryRunPath = path.join(normalizationDirectory, "vocab-db-dry-run.json");
const previewPath = path.join(
  normalizationDirectory,
  "vocab-db-normalized-preview.json",
);
const auditPath = path.join(normalizationDirectory, "vocab-db-update-audit.json");
